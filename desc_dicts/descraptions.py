...
Qid_Desc = {
    ...
    "Q7604686": {
        "ar": "صك قانوني في المملكة المتحدة",
        "en": "UK Statutory Instrument"
    },
    "Q820655": {
        "ar": "قانون تشريعي",
        "en": "statute"
...
tiny_wrwr = {
    ...
    'Q2557101': {
        'ar': 'منطقة خط أنبعاثات نووي منخفض التأين',
        'en': ''
    },  # 879
    'Q96311006': {
        'ar': '',
...
for qid, labs in Qid_Desc.items():
    Qid_Descraptions[qid] = {
        "ar": labs['ar']
    }
    DescraptionsTable[labs['en']] = {
        "ar": labs['ar']
    }
# ---
many_lang_qid_desc = {
