...
many_lang_qid_desc = {
    ...
    "Q6979593" : { # national association football team
        ...
        "en-gb":"national association football team",
    ...
    "Q3409032" : { # unisex given name
        ...
        "en-ca":"unisex given name",
        "en-gb":"unisex given name",
...
#---
#for x in DescraptionsTable:
    #printe.output( 'API.descraptions.py: "%s" :"%s" ' % (  x   , ""  )   )
    #if "uk" in DescraptionsTable[x] : 
        #printe.output( ""%s" :"%s" ' % (  x   , DescraptionsTable[x]["uk"]  )   )
#---