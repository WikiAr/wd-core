...
en_des_to_ar = {
    x.lower(): z
    for x, z in en_des_to_ar_no_lower.items()
}
# ---
Space_tab = {
...
nationalities = {
    ...
    "جنوب شرق آسيا": {
        "man": "آسيوي جنوب شرقي",
        "women": "آسيوية جنوب شرقية"
    },
    "أوروبا الجنوبية": {
        "man": "أوروبي جنوبي",
        "women": "أوروبية جنوبية"
    },
    "جنوب غرب آسيا": {
        "man": "جنوب غرب آسيوي",
    ...
    "جمهورية الكونغو الديمقراطية": {
        "man": "كونغولي ديمقراطي",
        "women": "كونغولية ديمقراطية"
    },
    "رومانيا": {
        "man": "روماني",
        "women": "رومانية"
    ...
    "أمريكا الوسطى": {
        "man": "أمريكي أوسطي",
        "women": "أمريكية أوسطية"
    },
    "أمريكا الشمالية": {
        "man": "أمريكي شمالي",
        "women": "أمريكية شمالية"
    },
    "أمريكا الجنوبية": {
        "man": "أمريكي جنوبي",
        "women": "أمريكية جنوبية"
    },
    "فيكتوريا (أستراليا)": {
        "man": "فيكتوري",
        "women": "فيكتورية"
...
for p50 in p50s:
    # ---
    SPARQLSE['dfd'] = '''SELECT ?item WHERE
        { ?item wdt:P31 wd:%s .
        ?item wdt:P50 ?auth.
