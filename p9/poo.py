...
#---
saoe = [
    #"python pwb.py p971/poo d:a"
    "python pwb.py p971/poo d:y"
    #,"python pwb.py p971/poo d:d"
    #,"python pwb.py p971/poo d:c"
    ,"python pwb.py p971/poo d:f"
    ,"python pwb.py p971/poo d:m"
    ]
#---
#import catenlog
import caten2
...
if __name__ == "__main__":
    ...
    for arg in sys.argv:#
        ...
        if arg =='d':
            ...
            elif value == 'm' or  value == 'dd':
                soo344 , file =  millennium__, file + '_millennium'
    ...
    #poo = {"economics history" : { "ar" : "تاريخ الاقتصاد" , "Q" : "Q8134" } }
    caten2.D_Y_C(poo , soo344 , type)
#---