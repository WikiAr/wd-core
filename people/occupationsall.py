...
translationsOccupations = {
    '~ cartoonist': {
        'ar': {'male': 'رسام كارتون ~', 'female': 'رسامة كارتون ~'},
        'en': {'male': '~ cartoonist', 'female': '~ cartoonist'},
    },
    '~ businessman and philanthropist': {
        'ar': {'male': 'فاعل خير ورائد أعمال ~', 'female': 'فاعلة خير ورائدة أعمال ~'},
        'en': {'male': '~ businessman and philanthropist', 'female': '~ businesswomen and philanthropist'},
    },
    '~ philanthropist': {
        'ar': {'male': 'فاعل خير ~', 'female': 'فاعلة خير ~'},
        'en': {'male': '~ philanthropist', 'female': '~ philanthropist'},
    },
    '~ pharmacist': {
    ...
    '~ archbishop': {
        'ar': {'male': 'رئيس أساقفة ~', 'female': 'رئيسة أساقفة ~'},
        'en': {'male': '~ archbishop', 'female': '~ archbishop'},
        'es': {'male': 'arzobispo ~', 'female': 'arzobispo ~'},
    },
    '~ activist': {
        'ar': {'male': 'ناشط ~', 'female': 'ناشطة ~'},
        'en': {'male': '~ activist', 'female': '~ activist'},
    },
    '~ actor': {
    ...
    '~ bicycle racer': {
        'ar': {'male': 'دراج ~', 'female': 'متسابقة دراجات ~'},
    ...
    '~ businessman': {
        ...
        'en': {'male': '~ businessman', 'female': '~ businesswomen'},
    },
    '~ businessperson': {
        'ar': {'male': 'رائد أعمال ~', 'female': 'رائدة أعمال ~'},
    ...
    '~ football player': {
        ...
        'nl': {'male': '~ footballspeler', 'female': '~ footballspeelster'},
        'es': {'male': 'futbolista ~', 'female': 'futbolista ~'},
        'fr': {'male': 'joueur de football ~', 'female': 'joueuse de football ~'},
        'gl': {'male': 'futbolista ~', 'female': 'futbolista ~'},
    ...
    '~ lexicographer': {
        'ar': {'male': 'معجمي ~', 'female': 'معجمية ~'},
        'en': {'male': '~ lexicographer', 'female': '~ lexicographer'},
    },
    '~ mathematician': {
    ...
    '~ racing cyclist': {
        ...
        'bn': {'male': '~ সাইক্লিস্ট', 'female': '~ সাইক্লিস্ট'},
        'ca': {'male': 'ciclista ~', 'female': 'ciclista ~'},
        'en': {'male': '~ racing cyclist', 'female': '~ racing cyclist'},
        'es': {'male': 'ciclista ~', 'female': 'ciclista ~'},
        'et': {'male': '~ jalgrattur', 'female': '~ jalgrattur'},
        'fr': {'male': 'cycliste ~', 'female': 'cycliste ~'},
        'gl': {'male': 'ciclista ~', 'female': 'ciclista ~'},
    ...
    '~ rules footballer': {
        'ar': {'male': 'لاعب كرة قدم ~', 'female': 'لاعبة كرة قدم ~'},
        'en': {'male': '~ rules footballer', 'female': '~ rules footballer'},
        'nl': {'male': '~ Gridiron Footballspeler', 'female': '~ Gridiron Footballspeler'},
    },
    '~ screenwriter': {
